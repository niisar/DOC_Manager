    ...
    app.controller("newctrl", function ($scope, $animate, $filter, ngDialog, taskSvc, $timeout) {
        ...
        $scope.ContractMaster = {
            columnDefs: [
                { headerName: '', width: 30, checkboxSelection: true },
                  { field: 'Desc', headerName: 'Contract Description', width: 990 },
            ],
        ...
        $scope.GetContractMaster = function () {
            $scope.ContractMaster.rowData = [
                ...
                { 'id': '10', 'ContractType': '2', 'nodes': [], 'Title': '', 'Desc': '"Software" includes the executable computer programs and any related printed, electronic and online documentation and any other files that may accompany the product.' },
                { 'id': '11', 'ContractType': '2', 'nodes': [], 'Title': '', 'Desc': 'Title, copyright, intellectual property rights and distribution rights of the Software remain exclusively with the Vendor. Intellectual property rights include the look and feel of the Software. This Agreement constitutes a license for use only and is not in any way a transfer of ownership rights to the Software.' },
                { 'id': '12', 'ContractType': '2', 'nodes': [], 'Title': '', 'Desc': 'This Agreement grants a site license to the Licensee. The Software may be loaded onto a maximum of 3 computers.' },
                { 'id': '13', 'ContractType': '2', 'nodes': [], 'Title': '', 'Desc': 'The Software may not be modified, reverse-engineered, or de-compiled in any manner through current or future available technologies.' },
            ];
